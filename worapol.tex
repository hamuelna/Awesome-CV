...
\address{
    ...
    Flat 28 Canal point, 22 West Tollcross Street, Edinburgh, United Kingdom (Current Residential Address)
}
...
\quote{``Don't forget the fundamentals"}
